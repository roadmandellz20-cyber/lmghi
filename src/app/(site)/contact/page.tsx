    ...
    <article className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6">
      <header>
        ...
        <p className="mt-4 text-base text-neutral-600">
          Use the form for general inquiries. For partnerships: partnerships@lmghi.org
        </p>
      </header>
      ...
      <section className="mt-10">
        <Card title="Message LMGHI">
          <form action="/api/forms/contact" method="POST" className="grid gap-4">
            ...
            <input name="subject" placeholder="Subject" required className="rounded-xl border border-neutral-300 px-4 py-3 text-sm" />
