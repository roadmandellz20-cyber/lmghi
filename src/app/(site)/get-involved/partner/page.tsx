...
export const metadata = baseMetadata({ title: "Partner" });

export default function PartnerPage() {
  return (
    <article className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6">
      <header>
        <h1 className="text-4xl font-semibold tracking-tight">Partner</h1>
        <p className="mt-4 text-base text-neutral-600">
          Institutional partnerships: delivery, evidence, accountability.
        </p>
      </header>

      <section className="mt-10">
        <Card title="Partnership inquiry">
          <form action="/api/forms/partner" method="POST" className="grid gap-4">
            ...
            <input name="organization" placeholder="Organization" required className="rounded-xl border border-neutral-300 px-4 py-3 text-sm" />
